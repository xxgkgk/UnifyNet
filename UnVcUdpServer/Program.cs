...
namespace UnVcUdpServer
{
    class Program
    {
        ...
        // 文件大小阀值
        // 1M = 1048576
        static int fileSize = Convert.ToInt32(ConfigurationManager.AppSettings["fileSize"]);
        ...
        // Img1路径
        static string Img1_Path = ConfigurationManager.AppSettings["Img1_Path"];

        // Img1域名
        static string Img1_Domain = ConfigurationManager.AppSettings["Img1_Domain"];
